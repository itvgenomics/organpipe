...
| `run_trimming`    | `Yes`               | Run Fastp for adapter anda quality trimming: "Yes" to perform trimming, "No" to skip.                                                                                                   | Optional, default is "No".                   |
| `adapters`          | `/path/to/adapters.txt` | Path to a text file listing adapter sequences to remove. Use this field if Fastp do not support your adapters.                                                                                                                             | Optional        |
