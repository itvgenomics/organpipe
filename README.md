...
| `reference`         | `/path/to/ref.fasta`| Path to a reference genome in fasta format. Leave blank if unavailable.                                                                                                            | Optional.                                     |
| `sequencing_type`   | `Short`             | Type of sequencing data: "Short" for Illumina or "Long" for PacBio/ONT reads.                                                                                                       | Required.                                     |
| `genome_range`      | `12000-22000`       | Expected genome size range in kilobases.                                                                                                                                             | Required.                                     |
...
| `run_nhmmer`        | `No`                | Run nhmmer to identify ncRNA and intergenic regions.                                                                                                                                | Optional. Default is "No".                    |
...
| `run_images`        | `Yes`               | Generate visualizations like OGDraw diagrams and depth plots.                                                                                                                       | Optional. Default is "Yes".                   |
